...
export function setSessionCookies(response: NextResponse, options: SessionCookieOptions): void {
  const { authToken, sessionMaxAgeSeconds, csrfMaxAgeSeconds, csrfToken } = options
